...
import com.vanir.updater.service.DownloadCompleteIntentService;
import com.vanir.updater.service.DownloadService;
...
public class DownloadReceiver extends BroadcastReceiver{
    ...
    public static final String ACTION_START_DOWNLOAD = "com.vanir.updater.action.START_DOWNLOAD";
    public static final String EXTRA_UPDATE_INFO = "update_info";

    public static final String ACTION_DOWNLOAD_STARTED = "com.vanir.updater.action.DOWNLOAD_STARTED";

    static final String ACTION_INSTALL_UPDATE = "com.vanir.updater.action.INSTALL_UPDATE";
